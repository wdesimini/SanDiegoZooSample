...
struct ZooExperiences {
    static let specialExperiences = [SpecialExperience(imageString: "Inside Look Tours_TN",
...
""",
    ...
    static let activities = [Activity(title: "Balboa Park Miniature Train",
    ...
    static let animalEncounters = [AnimalEncounter(title: "Keeper Talks: Insects",
    ...
    static let shows = [Show(title: "Dr. Zoolittle and Friends Explore Australia",
    ...
    static let playAreas = [PlayArea(title: "Elephant Play Yard",
